 ...
 */
@FragmentScope
public class SearchRecordsModel extends BaseModel implements SearchRecordsContract.Model{
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public SearchRecordsModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<WanAndroidResponse<List<HotKey>>> getHotWords() {
