 ...
 */
@FragmentScope
public class ProjectPagerModel extends BaseModel implements ProjectPagerContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public ProjectPagerModel(IRepositoryManager repositoryManager) {
